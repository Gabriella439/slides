...
- <span style="color: #FFFFFF">`Maybe`</span> - not `MaybeT Identity`
- <span style="color: #FFFFFF">`Either`</span> - not `ExceptT Identity`
- <span style="color: #FFFFFF">`[]`</span> - not `ListT Identity`
- <span style="color: #FFFFFF">`IO`</span> - no such thing as `IOT`
- <span style="color: #FFFFFF">`STM`</span> - no such thing as `STMT`
- <span style="color: #FFFFFF">`Identity`</span> - not `IdentityT Identity`
...
The downside is slower compile times
...
If you like my work, you can find my various social media accounts at:
